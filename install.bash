...
copy_tpl "$BASE_SETTINGS_DIR/templates/tools"         "./tools"
copy_tpl "$BASE_SETTINGS_DIR/.gitignore"    "./.gitignore"
copy_tpl "$BASE_SETTINGS_DIR/templates/.clang-format" "./.clang-format"
copy_tpl "$BASE_SETTINGS_DIR/templates/.clang-tidy"   "./.clang-tidy"
